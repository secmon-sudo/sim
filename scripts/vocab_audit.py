...
_JUDGE_SYSTEM = (
    ...
    "EMNİYET, GÜVENLİK DEĞİLDİR (hayır): sarhoş ya da taşkın yolcu, uçak içi "
    "kavga, tıbbi acil iniş, pist ihlali, iniş takımı arızası, kuş çarpması. "
    "Kimsenin kasıtlı bir düşmanca eylemi yoksa olay bu sistemin konusu değildir "
    "— tek bir sarhoş yolcu yüzünden yapılan acil iniş, kapının kaçırdığı bir "
    "güvenlik olayı olarak sayılmamalıdır.\n\n"
